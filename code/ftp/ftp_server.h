...
extern ULONG FTPS_Handler_CWD(FTP_USER_S *pUser);
...
extern ULONG FTPS_Handler_PASV(FTP_USER_S *pUser);
...
extern socket_t FTPS_GetSocket();
extern VOID FTPS_SetSocket(socket_t socket);
extern FTP_CMD_HANDLE_S * FTPS_GetHandler(CHAR *szCMD);
extern VOID FTPS_Run(socket_t socket);
