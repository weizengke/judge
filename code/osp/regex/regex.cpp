...
#include <stdlib.h>
#else
/* BEGIN: Added by weizengke, 2013/11/15 */
char *malloc ();
char *realloc ();
#endif
...
/* BEGIN: Added by weizengke, 2013/11/16 del for jungle*/
#if 1
                      ...
                      for (r = *p; r < *p + *(p + 1); r++)
                        {
                          ...
                          /* xx why this test?  */
						  /* BEGIN: Added by weizengke, 2013/11/15 for jungle */
	...
	/* \<digit> has been turned into a `duplicate' command which is
        ...
        case duplicate:
	  {
		...
		if (translate
                    ...
                    : bcmp ((unsigned char*)d, (unsigned char*)d2, mcnt))
		  goto fail;
		d += mcnt, d2 += mcnt;
	      }
	  }
