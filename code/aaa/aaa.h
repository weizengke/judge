...
extern char *AAA_GetUserFtpDirectory(char *uname);
extern ULONG AAA_SetUserFtpDirectory(ULONG vtyId, char *uname, char *directory);
extern ULONG AAA_SetUserServiceType(ULONG vtyId, char *uname, ULONG serviceType, ULONG isUndo);
